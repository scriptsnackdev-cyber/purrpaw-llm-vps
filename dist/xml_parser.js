...
// ---------------------------------------------------------------------------
export const parseNestedXML = (xmlString, keys) => {
    if (!xmlString)
        return null;
    const result = {};
    let hasData = false;
...
export const parseKeyValPT = (ptStr) => {
    if (!ptStr)
        return null;
    const result = {};
    let hasData = false;
...
// ---------------------------------------------------------------------------
const extractReply = (responseText) => {
...
// MAIN PARSER
// ---------------------------------------------------------------------------
export const parseXMLOutput = (responseText) => {
    try {
        ...
        if (mobileUpdatesStr) {
            try {
                mobileUpdates = JSON.parse(mobileUpdatesStr);
            }
            catch { /* ignore */ }
        }
